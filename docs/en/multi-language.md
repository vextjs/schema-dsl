...
Multilingual capabilities are provided by `Locale`, `dsl.config({ i18n })` and authentication options `locale`.
...
- Scan language packs from directory: `dsl.config({ i18n: '/path/to/locales' })`
