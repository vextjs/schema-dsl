...
- [基础示例](#基础示例)
  ...
  - [示例 2: 处理验证失败](#示例-2-处理验证失败)
- [高级示例](#高级示例)
  - [示例 3: 验证字符串约束](#示例-3-验证字符串约束)
  - [示例 4: 验证数字范围](#示例-4-验证数字范围)
  - [示例 5: 验证邮箱格式](#示例-5-验证邮箱格式)
  - [示例 6: 验证枚举值](#示例-6-验证枚举值)
  - [示例 7: 验证嵌套对象](#示例-7-验证嵌套对象)
  - [示例 8: 验证数组](#示例-8-验证数组)

### 高级功能
- [使用默认值](#使用默认值)
- [使用已编译的验证函数](#使用已编译的验证函数)
- [错误处理最佳实践](#错误处理最佳实践)
- [性能优化建议](#性能优化建议)
- [常见问题](#常见问题)
